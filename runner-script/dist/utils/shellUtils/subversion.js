...
const svnCheckout = (repoUrl, folderToCheckoutInto, svnCredentials) => {
    ...
    if (isHTTP && svnCredentials) {
        ...
        command = `svn co svn+ssh://${svnCredentials.username}:${svnCredentials.pat}@${repoUrl.split('svn+ssh://')[1]} ${folderToCheckoutInto}`;
    }
    else {
